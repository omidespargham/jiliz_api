    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand', models.ForeignKey(blank=True, default='نامعلوم', null=True, on_delete=django.db.models.deletion.CASCADE, to='advert.brand', to_field='name')),
                ...
                ('country', models.ForeignKey(blank=True, default='نامعلوم', null=True, on_delete=django.db.models.deletion.CASCADE, to='advert.country', to_field='name')),
            ],
        ),
    ]
